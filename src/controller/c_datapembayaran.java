 ...
 */
public class c_datapembayaran {
    v_datapembayaran view;
    
       public c_datapembayaran(v_datapembayaran view){
            this.view = view;
            ...
            this.view.pengaduan(new datapengaduan());
        }

    private class datapengaduan implements ActionListener {
