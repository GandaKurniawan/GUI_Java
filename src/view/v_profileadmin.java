 ...
 */
public class v_profileadmin extends javax.swing.JFrame {

    /**
     * Creates new form v_profileadmin
     */
    public v_profileadmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_profileadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_profileadmin().setVisible(true);
            }
        });
    }
