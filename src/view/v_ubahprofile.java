 ...
 */
public class v_ubahprofile extends javax.swing.JFrame {

    /**
     * Creates new form v_ubahprofile
     */
    public v_ubahprofile() {
        initComponents();
    }
    
     public void simpanprofile (ActionListener action) {
        simpan.addActionListener(action);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_ubahprofile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_ubahprofile().setVisible(true);
            }
        });
    }
