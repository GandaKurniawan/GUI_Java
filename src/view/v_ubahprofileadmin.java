 ...
 */
public class v_ubahprofileadmin extends javax.swing.JFrame {

    /**
     * Creates new form v_ubahprofileadmin
     */
    public v_ubahprofileadmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_ubahprofileadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_ubahprofileadmin().setVisible(true);
            }
        });
    }
